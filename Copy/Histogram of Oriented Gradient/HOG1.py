...
img1 = cv2.imread("/Users/taanhtuan/Desktop/PycharmProject/ML project/Tu lam/Celebrities regconition/Dataset/donald trump/1.jpeg"
                  , cv2.IMREAD_GRAYSCALE)
img = cv2.resize(src=img1, dsize=(64, 128))
f = hog(img1)
